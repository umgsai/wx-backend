...
Page({
    ...
    onLoad: function () {
        ...
        */
        ...
        var urlPostList = app.globalData.url + '/api/article/list';
        ...
        // @todo 文章列表网络请求API数据 
        request.requestPostJsonApi(urlPostList, token, params, this, this.successPostList, this.failPostList);
        ...
        this.setData({
            bannerPost: [{
                id: 1,
                title: "xxx-1",
                thumbnail: "https://res1.eqh5.com/FsT7I66V1CulAEnyy9xvyef6hFEf",
                createTime: "2020-5-5 14:02:18"
            }, {
                id: 2,
                title: "xxx-2",
                thumbnail: "https://res1.eqh5.com/FskpMG9xzxveRP4wSdIL1uzKdPgz?imageMogr2/auto-orient/thumbnail/488x944%3E/format/webp",
                createTime: "2020-5-3 10:42:18"
            }]
        });
