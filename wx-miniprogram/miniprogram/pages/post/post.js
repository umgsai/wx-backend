...
Page({
    ...
    onLoad: function (options) {
        ...
        var urlContent = app.globalData.url + '/api/article/view';
        ...
        var urlComments = app.globalData.url + '/api/comment/list';
        //@todo 评论列表网络请求API数据
        request.requestPostJsonApi(urlComments, token, params, this, this.successComment, this.failComment);
    ...
    successFunPost: function (res, selfObj) {
        ...
        that.setData({
            ...
            postContent: res.data.articleContent,
        ...
        if (!that.data.commentContent) {
            ...
            wx.cloud.callFunction({
                ...
                if (ckres.result.errCode == 0) {
                    var urlPostList = app.globalData.url + '/api/comment/add';
                    var token = app.globalData.token;
                    var params = {
                    ...
                    //@todo 网络请求API数据
                    request.requestPostJsonApi(urlPostList, token, params, this, this.successSendComment, this.failSendComment);
                } else {
                    // wx.hideLoading();
                    // wx.showModal({
                    //     title: '提醒',
            ...
            */
            ...
            var params = {
                ...
                articleId: that.postId,
                email: "aquanlerou@eunji.cn",
                parentId: 0,
                articleId: that.data.postId,
            };
            //@todo 网络请求API数据
            request.requestPostJsonApi(urlPostList, token, params, this, this.successSendComment, this.failSendComment);
        }
    ...
    Likes: function () {
        ...
        wx.request({
            url: app.globalData.url + '/api/article/addLikes',
            method: "POST",
            data: {
